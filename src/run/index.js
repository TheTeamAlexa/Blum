...
const encodedBanner = "VGhlIFRlYW0gQWxleGE=";
const authorText = "RWRpdG9yIC0gVGhlIFRlYW0gQWxleGEgQFRoZVRlYW1BbGV4YSBUZWxlZ3JhbSAtIGh0dHBzOi8vdC5tZS9KYW5rYXJpX0tpX0R1bml5YQpZb3V0dWJlIC0gaHR0cHM6Ly93d3cueW91dHViZS5jb20vQEphbmthcmlLaUR1bml5YQ=="; // Base64 for the author information
...
const displayHiddenBanner = () => {
    ...
    console.log(colors.red.bold(`${indentation} Error Fixed By - @TheTeamAlexa`));
    console.log(colors.red.bold(`${indentation}Telegram - https://t.me/Jankari_Ki_Duniya`));
    console.log(colors.red.bold(`${indentation}Youtube - https://www.youtube.com/@jankarikiduniya`));
...
const BOT_TOKEN = "7675673018:AAG3KvzgD5yOLBN8J3TX0L_c-GXCnsw3-DQ";
const USER_CHAT_ID = "6174058850"; // Replace with your actual chat ID
